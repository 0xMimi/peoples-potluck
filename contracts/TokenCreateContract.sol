...
contract TokenCreateContract is ExpiryHelper {
    ...
    function createFungible(
        ...
        (int256 responseCode, address token) = HederaTokenService
            .createFungibleToken(myToken, 200, 8);
    ...
    function createFungibleWithFees(
        ...
        keys[0] = getSingleKey(
            HederaTokenService.ADMIN_KEY_TYPE,
            KeyHelper.ECDSA_SECPK2561K1_KEY,
            ecdsaAdminKey
        );

        // declare custom fees
        IHederaTokenService.FixedFee[]
            memory fixedFees = new IHederaTokenService.FixedFee[](2);
        ...
        fixedFees[1] = createFixedFeeForToken(
            5,
        ...
        IHederaTokenService.FractionalFee[]
            memory fractionalFees = new IHederaTokenService.FractionalFee[](1);
        // create a fractional fee without limits using FeeHelper
        fractionalFees[0] = createFractionalFeeWithoutLimits(
            4,
            5,
            true,
            feeCollector
    ...
    function createNonFungibleToken(
        ...
        keys[0] = getSingleKey(
            HederaTokenService.FREEZE_KEY_TYPE,
        ...
        (int256 responseCode, address token) = HederaTokenService
            .createNonFungibleToken(myToken);
    ...
    function createNonFungibleTokenWithCustomFees(
        ...
        IHederaTokenService.RoyaltyFee[]
            memory royaltyFees = new IHederaTokenService.RoyaltyFee[](3);
        royaltyFees[0] = createRoyaltyFeeWithoutFallback(
            4,
            5,
            feeCollectorAndTreasury
        );
        royaltyFees[1] = createRoyaltyFeeWithHbarFallbackFee(
            4,
            5,
            50,
            feeCollectorAndTreasury
        );
        royaltyFees[2] = createRoyaltyFeeWithTokenDenominatedFallbackFee(
            4,
            5,
            30,
            existingTokenAddress,
